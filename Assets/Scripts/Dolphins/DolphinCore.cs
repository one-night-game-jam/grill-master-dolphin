...
namespace Dolphins
{
    public class DolphinCore : MonoBehaviour
    {
        ...
        bool IsTimeUp => PlayTime < PastTime;
        public IObservable<bool> IsTimeUpAsObservable => this.ObserveEveryValueChanged(x => x.IsTimeUp);

        public IObservable<bool> Fire => input.Fire.CombineLatest(IsTimeUpAsObservable, (fire, isTimeUp) => fire && !isTimeUp);
